  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#050505] border-b border-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-bg-base mb-12">The Process in {locationCity}</h2>
            ...
            {[
              ...
              <div key={step} className="flex gap-8 pb-12 relative">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full border-2 border-accent flex items-center justify-center text-accent font-heading font-bold text-lg flex-shrink-0 bg-primary z-10">
                    {i + 1}
                  </div>
                  {i < 3 && <div className="flex-1 w-px bg-white/10 mt-2"></div>}
                </div>
                <div className="pt-2 pb-8">
                  <h3 className="text-xl font-heading font-bold text-bg-base mb-2">{step}</h3>
    ...
    return (
      <section className="py-24 px-4 sm:px-6 lg:px-8 border-b border-white/5">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-bg-base mb-12 text-center">How We Roll Out {serviceName}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={step} className="bg-[#0A0A0A] p-8 border border-white/10 rounded-xl hover:border-accent/40 transition-all">
                    <h3 className="text-xl font-heading font-bold text-bg-base mb-3 text-accent">{step}</h3>
                    <p className="text-text-muted leading-relaxed">{detail}</p>
                </div>
              ))}
            </div>
